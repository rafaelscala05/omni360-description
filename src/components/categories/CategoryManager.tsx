...
import { fetchCategories, saveCategory, getEffectiveAttributes } from '../../services/categoryService';
import { Plus, Edit, Trash2, Tag, Save, ArrowLeft, Loader2, Sparkles, Folder } from 'lucide-react';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (parent) {
        ...
        // Ensure pathIds includes ancestors and the parent itself
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-hidden min-h-0">
        ...
        <div className="flex-1 p-4 md:p-6 overflow-y-auto bg-gray-50">
          {(isEditing || selectedCategory) ? (
            <div className="max-w-3xl border border-gray-200 rounded-xl bg-white shadow-sm overflow-hidden">
                              ...
                              <div className="flex-1">
                                ...
                                <input 
                                  ...
                                  onChange={(e) => {
                                    ...
                                    newAttrs[idx].label = e.target.value; // keep them in sync for simplicity
