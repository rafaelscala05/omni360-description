...
import { X, Check, RefreshCw, Globe, ExternalLink, Play } from 'lucide-react';
...
// Article detail: shows pipeline progress/outputs, lets the user edit the final
// text, approve, and publish to WordPress (Fase 4 review + Fase 5 publish).
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-start justify-between gap-4 p-5 border-b border-slate-100">
          <div className="min-w-0">
            ...
            <p className="text-xs text-slate-400">KW: {article.kwPrincipal} · {article.scheduledDate}</p>
          </div>
